...
namespace Saruman.Utilies.CryptoGrafy
{
    class crypt
    {
        ...
        public static string Saruman_decrypt()
        {
        ...
        public static string AESDecript(string stringa)
        {
            if (string.IsNullOrEmpty(stringa))
                throw new ArgumentNullException("sifreliMetin");
            if (string.IsNullOrEmpty(Saruman_decrypt()))
                throw new ArgumentNullException("sifre");
            ...
            try
            {
                ...
                Rfc2898DeriveBytes key = new Rfc2898DeriveBytes(Saruman_decrypt(), _salt);
